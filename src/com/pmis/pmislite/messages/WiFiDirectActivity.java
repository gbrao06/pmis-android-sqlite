...
public class WiFiDirectActivity extends Activity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    buttonDiscover = (Button)findViewById(R.id.searchDevisesButton);
    ...
    Button buttonEnable = (Button)findViewById(R.id.toggleWifiDirectButton);
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      switch (state) {
        case (WifiP2pManager.WIFI_P2P_STATE_ENABLED): 
          buttonDiscover.setEnabled(true);//equalent to activity.setIsWifiP2pEnabled(true);	
          break;
        default: 
