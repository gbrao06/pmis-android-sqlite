	...
	SQLiteOpenHelper db=null;
	  ...
	  private class InsertTask extends
	    ...
	    protected Void doInBackground(Object... params) {
	      ...
	      db.getWritableDatabase().insertOrThrow(table, nullColumnHack, values);
	      
	      //conflictAlgorithm
	      //db.getWritableDatabase().insertWithOnConflict(table, nullColumnHack, initialValues,db.getWritableDatabase().CONFLICT_IGNORE)
	      return(null);
	    }
	  }
